...
thick_dir = 'results/2025-12-07 18:49:42/best_individual_57.npy'
thick_list = np.load(thick_dir)
print(np.sum(thick_list >= 20))
mask_dir = '../dataset/mask/10-200/mask_best_28.mat'
T_lists = cal_response_batch(thick_list, bands, 'nk_map_special.pkl')
mask = T_lists.reshape(4, 4, 28)
large_mask = np.tile(mask, (64, 64, 1))
scio.savemat(mask_dir, {'mask': large_mask})
