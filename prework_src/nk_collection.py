...
def get_n_list(material_nk_low, material_nk_high, material_nk_substrat, wavelength_list, layer_num=20, output_path='data/nk_map_special.pkl'):
    nk_map = {}
...
if __name__ == '__main__':
    ...
    with open('data/nk_map.pkl', 'rb') as f:
