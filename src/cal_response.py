...
def get_n_list(material_nk_low, material_nk_high, material_nk_substrat, layer_num=20, output_path='data/nk_map.pkl'):
    nk_map = {}
    nk_list = []
...
def cal_response(d_list, lambda_list, nk_path='data/nk_map.pkl'):
...
def cal_response_batch(thick_designs, lambda_list=np.linspace(400, 700, 301), nk_path='data/nk_map.pkl'):
